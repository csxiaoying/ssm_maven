...
public class StoreControllerTest {
    ...
    public void testSave() throws Exception {
        //创建书架创建的请求
        //请求方式为post
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/user/save.do");
        //添加编号为MockMvc的书架
        mockHttpServletRequestBuilder.param("userName", "英");
        //书架为两层
        mockHttpServletRequestBuilder.param("password", "3333");
