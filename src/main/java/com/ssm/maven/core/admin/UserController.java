...
import com.ssm.maven.core.util.Constants;
...
public class UserController {
    ...
    public String login(User user, HttpServletRequest request) {
        try {
            String MD5pwd = MD5Util.MD5Encode(user.getPassword(), Constants.UTF_8);
